...
class VueChoixSpe extends Vue
{
    public function __construct($layout)
    {
        parent::__construct($layout);

        $this->headContent = '<title>Objectif BUT - Choix d\'une spécialité</title>
            <script src="../javascript.js"></script>
            <link rel="stylesheet" href="../sources/css/styleChoix.css">
            <meta name="description" content="Page de choix d\'une spécialité pour le jeu Objectif BUT">
        ';

        $this->content = '<header>
                <a href="/sae/index.php"><h1 class="titre">Objectif </h1></a>
                <a href="/sae/index.php"><h1> BUT</h1></a>
            </header>
            <div class="menu">
                ...
                <div id="popup_video">
                    <div class="affiche">
                        ...
                        <div class="corpsChoix">
                            ...
                            <form method="post" action="/sae/index.php/jeux">
